...
ActiveRecord::Schema.define(version: 20190322032152) do

  create_table "organizational_events", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
